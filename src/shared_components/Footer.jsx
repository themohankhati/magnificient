    ...
    <footer className="bg-gray-100 py-10 text-black text-sm">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start px-4">
        <div className="flex flex-col items-start">
          <img src="Homepage-pictures/Magnificent logo.png" alt="Magnificent Travels & Tours Logo" className="h-20 mb-4" />
        </div>
      ...
      <div className="border-t border-gray-300 mt-8 py-4 bg-gray-100">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center px-6">
          <div className="flex items-center">
            <img src="Homepage-pictures/Magnificent logo.png" alt="Magnificent Travels & Tours Logo" className="h-10 mr-3" />
            <div>
          ...
          <div className="flex items-center mt-4 md:mt-0">
            ...
            <div className="flex gap-4">
              <a href="#"><img src="Homepage-pictures/Facebook-logo.png" alt="Facebook" className="h-6" /></a>
              <a href="#"><img src="Homepage-pictures/instagram-logo.png" alt="Instagram" className="h-6" /></a>
              <a href="#"><img src="Homepage-pictures/x-logo.png" alt="X" className="h-6" /></a>
            </div>
          </div>
        </div>
      </div>
