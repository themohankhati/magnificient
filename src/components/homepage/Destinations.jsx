...
const Destinations = () => {
    const destinations = [
      { name: "NEPAL", img: "Homepage-pictures/Top destination-Nepal.jpg" },
      { name: "INDIA", img: "Homepage-pictures/Top destination-India.jpg" },
      { name: "TIBET", img: "Homepage-pictures/Top destination-tibet.jpg" },
      { name: "BHUTAN", img: "Homepage-pictures/Top destination-Bhutan.jpg" },
    ];
